...
La conexión remota, el despliegue público y el Filter exigido literalmente por el parcial no forman parte de la configuración actual. La aplicación protege cada controlador privado mediante `WEB-INF/jspf/seguridad.jspf`. Consultar `PENDIENTES.md` antes de sustentar o publicar.
