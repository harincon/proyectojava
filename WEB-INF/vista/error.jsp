  ...
  <div class="row justify-content-center">
    <div class="col-md-8 col-lg-6">
      <div class="card border-0 shadow-sm text-center p-4">
        <i class="bi <%= noEncontrada ? "bi-signpost-split" : "bi-exclamation-octagon" %> text-marca" style="font-size:3rem" aria-hidden="true"></i>
        ...
        <div><a class="btn btn-primary" href="<%= ctx %>/controlador/inicio.jsp">Volver al inicio</a></div>
      </div>
    </div>
  </div>
</div>
